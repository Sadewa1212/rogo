...
export default class NotFound extends React.Component<any, any> {
  ...
  render(): JSX.Element {
    return (
      <div className="w-full py-5 md:py-24 bg-blue-400 justify-center items-center flex md:flex-row flex-col">
        <img
          src={UnDrawOuterSpace}
          alt="Page Not Found"
          className="object-contain h-96 px-3 sm:hover:scale-105 sm:hover:mx-5 transition-all"
        />
        <div className="flex flex-col items-center md:items-start">
          <p className="text-center font-extrabold text-xl sm:text-2xl py-3 pt-3 text-white md:text-3xl">{`${this.title}`}</p>
          <a
            href="./"
